...
# Указываем путь к словарю.
wordlist_russian=list(open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'RUS.txt'),'r')) 
	...
	try:
		...
		try:
			...
			try:
				...
				raise RuntimeError("Реализация pbkdf2 небыла найдена!")
